...
function recordPaint(Elem,Data){
    ...
    var paddingLeft = 100;//至少大于绘制文字的宽度
    ...
    for(var i=1;i<=4;i++){
        ...
        // 绘制月份信息
        context.fillText(i+"周",month.x,month.y);
        // 改变每次绘制的x坐标轴的值
    ...
    */
    ...
    var moneyY = (origin.y - axisY.y)/(max/10+1);
    ...
    for(var i=0;i<Data.length;i++){
        ...
        if(i == 0){
            ...
            context.strokeStyle = '#fdc62e';
        }
        // 绘制折点的金额
        context.fillText(Data[i]+'元',pointX,pointY);
    }
    context.stroke();
    // 绘制12个折点的圆
    for(var i=0;i<Data.length;i++){
